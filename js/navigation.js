(function () {
  ...
  const navigationState = {
    cards: Array.isArray(cfg.navigationCards)
      ? cfg.navigationCards.slice()
      : [],
    filter: "all",
    filtersEnabled: !!cfg.enableNavigationFilters,
    filterTags: Array.isArray(cfg.navigationFilterTags)
      ? cfg.navigationFilterTags.filter(Boolean)
      : [],
    filterBar: null,
